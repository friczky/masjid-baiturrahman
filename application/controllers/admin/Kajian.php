...
class Kajian extends CI_Controller {
	...
	{	
		$data['kajian']	= $this->db->order_by('id','desc')->get('tb_kajian')->result();
	...
	{	
		$data['kajian']	= $this->db->where('id',$id)->get('tb_kajian')->row_array();
		$this->load->view('admin/v_kajian-edit',$data);
	}
