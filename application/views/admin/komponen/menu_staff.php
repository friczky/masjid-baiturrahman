        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/kajian')?>"><i class="fa fa-circle-o"></i> Data Kajian</a></li>
                <li><a href="<?= base_url('admin/kajian/add')?>"><i class="fa fa-circle-o"></i> Tambah Kajian</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
