                  ...
                  <div class="box-body">
                    ...
                    <?php $no=1; foreach($foto->result() as $f){?>
                        <tr>
                          ...
                          <td><a href="#edit" data-toggle="modal" data-target="#edit<?= $f->id?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a> | <a href="<?= base_url('admin/slider/delete/')?><?= $f->id?>" onclick="confirm('Apakah anda ingin menghapus foto ini?')"class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                        </tr>
                    <?php }?>
                      </tbody>
                    </table>
